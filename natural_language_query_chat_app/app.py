...
PROJECT_ID = "music-db-445310"
BIGQUERY_DATASET_ID = "song_dataset" 
...
st.set_page_config(
    page_title="AI Chat with Music Database",
...
with col2:
    st.image("/Users/jccl/Disk/DB/music-db-chat/vertex-ai.png")
...
with st.expander("Sample prompts", expanded=True):
    st.write(
        ...
        - Show me the top 10 longest songs in the database
